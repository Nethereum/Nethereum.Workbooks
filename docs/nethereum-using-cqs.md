...
The following will provide an example of how to easily deploy a[ Token Contract ](https://github.com/Nethereum/Nethereum.Workbooks/edit/master/StandardToken.sol)and interact with it using CQS.
...
Create a web3 instance based on our our new account object:
